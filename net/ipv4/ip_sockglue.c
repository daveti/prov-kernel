...
/* The provenance hooks in this function don't make that much sense because 
   it works exclusively with security contexts.  Punting for now. - A. Bates */
static void ip_cmsg_recv_security(struct msghdr *msg, struct sk_buff *skb)
{
	...
	*/
	...
	/*
	err = provenance_socket_getpeersec_dgram(NULL, skb, &provid);
	if (err)
		return;
	*/
	...
	/*
	err = provenance_provid_to_provctx(provid, &provdata, &provlen);
	if (err)
		return;
	*/
	...
	//provenance_release_secctx(provdata, provlen);
}
