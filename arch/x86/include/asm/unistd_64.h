...
#define __NR_current_provenance_id		312
__SYSCALL(__NR_current_provenance_id, sys_current_provenance_id)
#define __NR_process_id_to_provenance_id        313
__SYSCALL(__NR_process_id_to_provenance_id, sys_process_id_to_provenance_id)
