...
/* daveti:
 * this MPI internal bug has bothered me the whole weekend as 
 * I was not inclined to suspect the underlayer mpi_X calls.
 * But this time, I was right! The take-away here is that
 * DO NOT TRUST RH kernel 2.6.X code!
 * Moreover, trust yourself and do the damn debugging:)
 * Oct 6, 2014
 *
	if (xp)
		goto enomem;
